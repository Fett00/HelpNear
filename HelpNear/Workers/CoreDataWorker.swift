...
protocol CoreDataWorkerProtocolForAddOnly{
...
//Работа с core data
final class CoreDataWorker: CoreDataWorkerProtocol, CoreDataWorkerProtocolForGetOnly, CoreDataWorkerProtocolForDeleteOnly, CoreDataWorkerProtocolForAddOnly{
    
    // MARK: - Core Data stack

    lazy var persistentContainer: NSPersistentContainer = {

        let container = NSPersistentContainer(name: "HelpNear")
    ...
    /// Функция возвращает кол-во элементов по заданным параметрам
